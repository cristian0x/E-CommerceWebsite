...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value = "INSERT INTO orders (order_tracking_number, user_address_id, user_id, status, payment_method_id, shipping_method_id) " +
            "VALUES (:order_tracking_number, :user_address_id, :user_id, :status, :payment_method_id, :shipping_method_id)", nativeQuery = true)
    void insertOrder(@Param("order_tracking_number") String order_tracking_number, @Param("user_address_id") Long user_address_id,
                     ...
                     @Param("shipping_method_id") Long shipping_method_id);
}
